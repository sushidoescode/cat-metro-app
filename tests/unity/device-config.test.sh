...
# this criterion is PlayMode DeviceConfigTests.AllRuntimeRenderers_BindGreybox_TextMeshSurvives
# (real materials on real renderers, ring asserted explicitly).

namespace CatMetro.Presentation.Props
{
    ...
    public static class PropRole
    {
        ...
        public const string StationLamp = "station-lamp";
        public const string DepotSignpost = "depot-signpost";
        public const string FenceLine = "fence-line";
        public const string RimBush = "rim-bush";
        public const string TrailSignpost = "trail-signpost";

        public static bool IsDecorative(string role) =>
            role == PerimeterTrees || role == DeskClutter || role == ParkedEngine
            || role == StationLamp || role == DepotSignpost || role == FenceLine
            || role == RimBush || role == TrailSignpost;

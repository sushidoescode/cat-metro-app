...
namespace CatMetro.Bootstrap
{
    ...
    public sealed class GameRoot : MonoBehaviour
    {
        ...
        public static readonly string[] LevelBand = {
            ...
            "L016", "L017", "L018", "L019", "L020",
            "L021", "L022", "L023", "L024", "L025",
            "L026", "L027", "L028", "L029", "L030",
            "L031", "L032", "L033", "L034", "L035",
            "L036", "L037", "L038", "L039", "L040",
            "L041", "L042", "L043", "L044", "L045",
            "L046", "L047", "L048", "L049", "L050",
            "L051", "L052", "L053", "L054", "L055",
            "L056", "L057", "L058", "L059", "L060",
        };
        ...
        private void Update()
        {
                ...
                && _pendingHomeShowFrame < 0)
            {
                ...
                catch (System.Exception ex)
                {
                    ...
                    // Every unexpected halt stops motion audio. Wrong-station arrivals are
                    // ordinary ladder rejections observed from the snapshot path below.
                    try
                    {
                ...
                if (causal >= 0)
                {
                    ...
                    if (!MotionOff && View.TryGetCausalFunnel(causal, out var funnel))
                        BoardFx.GetOrCreate(View.transform, () => MotionOff).Emit(
                            BoardFxSprite.Puff, funnel, new Color(.58f, .58f, .58f, .9f), 1,
                            sizeWorld: .44f,
                            velocityWorld: Cam.transform.up * .55f - Cam.transform.forward * .3f);
                }

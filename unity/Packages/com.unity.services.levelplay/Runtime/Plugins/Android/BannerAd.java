...
public class BannerAd {
    ...
    private void setup(
        ...
        // IUnityBannerAdListener proxy crosses into the Unity scripting runtime, which can block for
        ...
        this.mBannerAdView.setBannerListener(new LevelPlayBannerAdViewListener() {
            ...
            public void onAdLoaded(LevelPlayAdInfo levelPlayAdInfo) {
                if (bannerListener != null) {
                    ...
                    AndroidBridgeUtilities.postBackgroundTask(() -> bannerListener.onAdLoaded(adInfo));
                }
            }
            ...
            public void onAdLoadFailed(LevelPlayAdError adError) {
                if (bannerListener != null) {
                    final String error = LevelPlayUtils.adErrorToString(adError);
                    AndroidBridgeUtilities.postBackgroundTask(() -> bannerListener.onAdLoadFailed(error));
                }
            }
            ...
            public void onAdDisplayed(LevelPlayAdInfo levelPlayAdInfo) {
                if (bannerListener != null) {
                    final String adInfo = LevelPlayUtils.adInfoToString(levelPlayAdInfo);
                    AndroidBridgeUtilities.postBackgroundTask(() -> bannerListener.onAdDisplayed(adInfo));
                }
            }
            ...
            public void onAdDisplayFailed(LevelPlayAdInfo levelPlayAdInfo,
                ...
                if (bannerListener != null) {
                    final String adInfo = LevelPlayUtils.adInfoToString(levelPlayAdInfo);
                    final String error = LevelPlayUtils.adErrorToString(adError);
                    AndroidBridgeUtilities.postBackgroundTask(() -> bannerListener.onAdDisplayFailed(adInfo, error));
                }
            }
            ...
            public void onAdClicked(LevelPlayAdInfo levelPlayAdInfo) {
                if (bannerListener != null) {
                    final String adInfo = LevelPlayUtils.adInfoToString(levelPlayAdInfo);
                    AndroidBridgeUtilities.postBackgroundTask(() -> bannerListener.onAdClicked(adInfo));
                }
            }
            ...
            public void onAdExpanded(LevelPlayAdInfo levelPlayAdInfo) {
                if (bannerListener != null) {
                    final String adInfo = LevelPlayUtils.adInfoToString(levelPlayAdInfo);
                    AndroidBridgeUtilities.postBackgroundTask(() -> bannerListener.onAdExpanded(adInfo));
                }
            }
            ...
            public void onAdCollapsed(LevelPlayAdInfo levelPlayAdInfo) {
                if (bannerListener != null) {
                    final String adInfo = LevelPlayUtils.adInfoToString(levelPlayAdInfo);
                    AndroidBridgeUtilities.postBackgroundTask(() -> bannerListener.onAdCollapsed(adInfo));
                }
            }
            ...
            public void onAdLeftApplication(LevelPlayAdInfo levelPlayAdInfo) {
                if (bannerListener != null) {
                    final String adInfo = LevelPlayUtils.adInfoToString(levelPlayAdInfo);
                    AndroidBridgeUtilities.postBackgroundTask(() -> bannerListener.onAdLeftApplication(adInfo));
                }
            }
        });
    }
    ...
    public void setImpressionDataListener(UnityImpressionDataListener listener) {
        ...
        this.mBannerAdView.setImpressionDataListener(nativeListener);
    }

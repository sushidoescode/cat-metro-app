...
| **CM-C10** *(tranche 3 — content stager; ratified human in-session 2026-08-05, N1)* | `scripts/stage-content.sh` · `tests/staging/**` · `tests/fixtures/staging/**` · **append-only** in `scripts/build.sh` · **mechanical `--apply` output** under `unity/Assets/StreamingAssets/**` (see the derived-tree annotation on the CM-C2b row) |

...
| **CM-C11** *(tranche 3 — L006–L010 alternation band; ratified human in-session 2026-08-05, delegated batch)* | `content/levels/L006.json` … `L010.json` *(new files only, inside CM-C2a's `content/levels/**`, line 116 — the L002-L005 (#15) precedent)* · `unity/Assets/Tests/EditMode/Pure/Corpus/**` **(unowned before this amendment)** · `tests/corpus/**` **(unowned before this amendment)** |
